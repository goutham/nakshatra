...
class LMR {
public:
  LMR(const int full_depth_moves, const int reduction_limit,
      const int depth_reduction_factor)
      : full_depth_moves_(full_depth_moves), reduction_limit_(reduction_limit),
  ...
  int DepthReductionFactor() const { return depth_reduction_factor_; }
